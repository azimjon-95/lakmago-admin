...
import { panelApi, type OrderStatus, type PanelOrder } from '@/api';
...
const statusMeta: Record<OrderStatus, { label: string; bg: string; color: string }> = {
...
export function OrdersPage() {
  ...
  function advance(order: PanelOrder) {
