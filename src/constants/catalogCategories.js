/*
 * Umumiy katalog kategoriyalari — endi faqat ichimlik uchun emas,
 * oziq-ovqat do'konlari (dukonlar) uchun ham moslashtirilgan (70 ta).
 *
 * Ko'rinish qoidasi (server tomonida majburlanadi, bu yerda faqat
 * tanlov/label uchun):
 *   - restoran/kafe/oshxona/choyxona — FAQAT "Ichimliklar" ko'radi
 *   - do'kon — barcha 70 tasini ko'radi
 *
 * Bu ro'yxat lakmago-server/src/constants/catalogCategories.js
 * bilan QIYMAT VA TARTIB jihatidan bir xil bo'lishi kerak — ikkala
 * repo alohida deploy qilingani uchun qo'lda sinxronlashtiriladi.
 */
...
export const catalogCategoryLabel = (value) =>
  CATALOG_CATEGORIES.find((c) => c.value === value)?.label || value;
