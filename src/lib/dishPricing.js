 ...
 * ═══════════════════════════════════════════════════════════
 *
 * DIQQAT: bu mantiq mijoz ilovasida va serverda ham AYNAN SHUNDAY
 * (lakmago-client/src/lib/dishPricing.js, lakmago-server/src/services/dishVariants.js). Ikkalasi bir
